...
public class Config {
    ...
    public static List<String> MESSAGES_GAME_STARTINGMESSAGE = List.of("&e============================", "Welcome to %game%!", "", "%description%", "&e============================");
    ...
    public static void refresh() {
        ...
        MESSAGES_GAME_STARTINGMESSAGE = MinigameLib.getInstance().getConfig().getStringList("messages.game.starting-message");
    }
}
